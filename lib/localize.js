...
var Localize = require("localize"),
    loc = new Localize({
        ...
        "EXCEPTION_MISSING_TOOLS": {
            "en": "BBNDK tools could not be found. Please ensure you have copied the dependencies folder from a WebWorks SDK installation into the root of the repo or have BBDNK installed and the PATH configured via bbndk-env script."
        },
